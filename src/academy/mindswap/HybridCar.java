...
public class HybridCar extends Car{
    ...
    public float calculateNecessaryBatteryPower(float distance) {
        return (distance * getBatteryConsumption()) / 100;
    }

    private boolean isEnoughtBatteryPower(float distance) {
        return calculateNecessaryBatteryPower(distance) <= getBatteryPowerLevel() ? true : false;
    }

    public void decreaseBattery(float batterySpent) {
    ...
    public float getBatteryPowerLevel() {
